...
void Debug_Print_PinState(GPIO_PinState pinState)
{
    if (pinState == GPIO_PIN_RESET)
    {
        Debug_Print("Sensor state: RESET\r\n");
    }
    else
    {
        Debug_Print("Sensor state: SET\r\n");
    }
}
/* USER CODE END 0 */
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  GPIO_PinState sensorState = HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0);
	          ...
	          else if (sensorState == GPIO_PIN_SET)
	          {
	              // No line detected
	          ...
	          {
	              // Unexpected state
	              Debug_Print("Unexpected sensor state\r\n");
	          }
