...
osThreadId led1_task1Handle;
osThreadId led2_Task2Handle;
osThreadId led3_Task3Handle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_led1_handler */
/**
  * @brief  Function implementing the led1_task1 thread.
...
/* USER CODE BEGIN Header_led2_handler */
/**
* @brief Function implementing the led2_Task2 thread.
* @param argument: Not used
* @retval None
*/
...
void led2_handler(void const * argument)
{
  ...
  /* USER CODE END led2_handler */
}

/* USER CODE BEGIN Header_led3_handler */
/**
* @brief Function implementing the led3_Task3 thread.
* @param argument: Not used
* @retval None
*/
